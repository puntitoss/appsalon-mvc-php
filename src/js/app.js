...
function seleccionarServicio(servicio) {
  ...
  if (servicios.some((agregado) => agregado.id === id)) {
    ...
    //Agregarlo
    //... toma una copia de lo que hay en el arreglo, y lo agrego el nuevo objeto (eso me crea un solo arreglo con informacion nueva) y reescribe en servicios
...
function seleccionarHora() {
  ...
  inputHora.addEventListener("input", function (e) {
    ...
    const hora = horaCita.split(":")[0]; //[0] porque genera un arreglo split
    if (hora < 10 || hora > 18) {
      e.target.value = "";
